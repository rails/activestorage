...
Active Storage makes it simple to upload and reference files in cloud services, like Amazon S3, Google Cloud Storage or Microsoft Azure and attach those files to Active Records. It also provides a disk service for testing or local deployments, but the focus is on cloud storage.
